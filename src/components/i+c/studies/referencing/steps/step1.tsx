...
import { getCandidateBasicData } from '@/api/i+c/Studies';
import SimpleLoading from '@/components/i+c/ui/SimpleLoading';
import { getCandidateFiles } from '@/api/i+c/Studies';
import { FileTypes } from '@/models/i+c/FileTypes';

export default function ReferencingStep1({ candidateId }: StepsProps) {
