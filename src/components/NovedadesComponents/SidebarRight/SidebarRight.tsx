...
export default function SidebarRight() {
    ...
    return (
        ...
        <>
            {
                novedadSelected ?
                    <section className="flex h-screen bg-transparent absolute top-0 right-0 shadow-2xl" data-theme="oberon">
                        <div className="flex flex-col justify-between w-[750px] h-full bg-base-100 border-l">
